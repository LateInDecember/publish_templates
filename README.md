...
bash install/bootstrap.sh "<새 프로젝트 절대경로>" --install     # macOS/Linux
# Windows는 먼저 ./install/install.ps1 실행 후, 폴더 생성은 bootstrap 대신 수동/에이전트
```

이후 **GUI 마무리**(직접): Zotero Better BibTeX auto-export 지정(`install/zotero_bbt_setup.md`), Obsidian 커뮤니티 플러그인 설치(`install/obsidian_starter/README.md`), `AGENTS.md` 플레이스홀더·`reporting_root`·마커 매핑 채우기.
